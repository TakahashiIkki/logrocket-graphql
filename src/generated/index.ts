...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("https://fakeql.com/graphql/2f4c5a08cff11766bc2250eb3f9d2108", {
      method: "POST",
...
export type PostsQuery = { __typename?: 'Query', posts?: Maybe<Array<Maybe<{ __typename?: 'Post', id: string, title: string }>>> };
